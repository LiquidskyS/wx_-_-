...
// 商品详情数据获取
  loadProductDetail:function(){
    var that = this;
    wx.request({
      url: app.d.ceshiUrl + '/index.php/Api/Product/index',
      method:'post',
      data: {
...
//添加到收藏
  addFavorites:function(e){
    var that = this;
    wx.request({
      url: app.d.ceshiUrl + '/index.php/Api/Product/col',
      method:'post',
      data: {
        uid: app.d.userId,
  ...
  addShopCart:function(e){ //添加到购物车
    var that = this;
    wx.request({
      url: app.d.ceshiUrl + '/index.php/Api/Shopping/add',
      method:'post',
      data: {
        uid: app.d.userId,
        pid: that.data.productId,
